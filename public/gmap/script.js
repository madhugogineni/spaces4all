            ...
            propertiesMap: function(e, t, n) {
                ...
                f = function(e, t) {
                    return function(n) {
                        ...
                        var s = '<div class="infobox pgl-property pgl-bg-light"><div class="property-thumb-info">' + '<div class="property-thumb-info-image">' + '<a href="javascript:;" class="close-info">x</a>' + '<a href="' + e.link + '"><img class="img-responsive" src="' + e.image + '" alt="' + e.title + '"></a>' + '<span class="property-thumb-info-label"><span class="label price">' + e.price + '</span><span class="label forrent">' + e.forrea + '</span></span>' + '</div>' + '<div class="property-thumb-info-content">' + '<h3>' + e.title + "</h3>" + e.location + '</div>' + '<div class="amenities clearfix">' + '<ul class="pull-right"><li>' + e.bedroom + '</li><li>' + e.bathroom + '</li></ul>' + '</div></div></div>';
